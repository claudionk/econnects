...
define("SMSMASS_NOOK_INVALID_NUMBER", 120);
define("SMSMASS_NOOK_INVALID_EMAIL", 121);
define("SMSMASS_NOOK_ANY_OR_ALL_URL_NOT_FOUND", 122);
define("SMSMASS_NOOK_NUMBER_OF_URL_AND_RECIPIENTS_NOT_MATCH", 123);
define("SMSMASS_NOOK_SERVICE_UNAVAILABLE", 124);
define("SMSMASS_NOOK_URL_NOT_FOUND", 125);
define("SMSMASS_NOOK_INVALID_DATE", 126);
define("SMSMASS_NOOK_INVALID_TRANS", 127);
define("SMSMASS_NOOK_TRANS", 128);
...
define("SMSMASS_DEL_EXPIRED", 305);
define("SMSMASS_DEL_DELETED", 306);
?>