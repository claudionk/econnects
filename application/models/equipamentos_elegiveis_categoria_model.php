<?php
Class Equipamentos_Elegiveis_Categoria_Model extends MY_Model
{
    //Dados da tabela e chave primária
    protected $_table = 'equipamentos_elegiveis_categoria';
    ...
    function with_sub_categoria($categoria_pai_id = 0, $equipamento_marca_id = 0){
        ...
        $this->_database->join("equipamentos_elegiveis e", "e.equipamento_sub_categoria_id = {$this->_table}.equipamento_categoria_id");
