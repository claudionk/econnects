...
*/
  ...
  public function with_cotacao_cliente_contato(){
    $this->_database->select('base_pessoa.base_pessoa_id as cod_cliente, cliente.razao_nome, cotacao_equipamento.equipamento_nome, equipamento_marca.nome as marca, equipamento_categoria.nome as categoria');
    ...
    $this->_database->join('base_pessoa', 'base_pessoa.cliente_id = cliente.cliente_id', 'inner');
