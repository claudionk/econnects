...
Class Produto_Parceiro_Regra_Preco_Model extends MY_Model
{
    ...
    */
    public function calculo_plano( $params = array(), $api = false ) {
        ...
        $result['valores_bruto'] = [];
        $result['valores_cobertura_adicional'] = [];
        $result['valores_totais_cobertura_adicional'] = [];
        $result['valores_liquido'] = [];
        $result['valores_liquido_total'] = [];
        ...
        if (number_format($comissao, 2, ',', '.') < number_format(0, 2, ',', '.') && $parceiro_id <> 76)
        {
