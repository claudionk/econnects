<?php
Class Cotacao_Generico_Model extends MY_Model
{
    //Dados da tabela e chave primária
    protected $_table = 'cotacao_generico';
    protected $primary_key = 'cotacao_generico_id';
    ...
    /**
     * Insere ou faz update na cotação de generico
    ...
    public function insert_update($produto_parceiro_id, $cotacao_id = 0, $step = 1, $coberturas_adicionais = null){
        ...
        if(isset($cotacao['servico_produto_id'])){
