 ...
 *
 */
class Produto_Parceiro_Plano_Destino_Model extends MY_Model {


    protected $_table = 'produto_parceiro_plano_destino';
    protected $primary_key = 'produto_parceiro_plano_destino_id';
