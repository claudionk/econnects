<?php
Class Cotacao_Equipamento_Cobertura_Model extends MY_Model
{
    //Dados da tabela e chave primária
    protected $_table = 'cotacao_equipamento_cobertura';
    protected $primary_key = 'cotacao_equipamento_cobertura_id';
    ...
    function with_cobertura()
    {
        ...
        $this->_database->join('cobertura_plano', 'cobertura_plano.cobertura_plano_id = cotacao_equipamento_cobertura.cobertura_plano_id');
