...
Class Cotacao_Equipamento_Model extends MY_Model
{
  ...
  public function insert_update($produto_parceiro_id, $cotacao_id = 0, $step = 1){
    ...
    if($cotacao_id) {
      ...
      //var_dump($cotacao_salva);exit("$cotacao_id");
    ...
    if($produto_parceiro['parceiro_id'] != $this->session->userdata('parceiro_id')){
      ...
      if( $rel ) {
        ...
        $configuracao['repasse_comissao'] = 0;
        $configuracao['repasse_maximo'] = 0;
        $configuracao['comissao'] = 0;
      }
    }
    ...
    */
    ...
    if(isset($cotacao['quantidade'])){
      $data_cotacao['quantidade'] = (int)$cotacao['quantidade'];
    }else{
      $data_cotacao['quantidade'] = 1;
    }
