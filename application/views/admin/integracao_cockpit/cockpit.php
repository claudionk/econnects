                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <a href="<?php echo base_url("admin/integracao_log/index/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-clock-o"></i>  Log </a>
                                    <a href="<?php echo base_url("admin/integracao_layout/index/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-edit"></i>  layout </a>
                                    ...
                                    <a href="<?php echo base_url("{$current_controller_uri}/copy/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-copy"></i>  Copiar </a>
