    ...
    <div class="form-wizard-nav">
        ...
        <ul class="nav nav-justified">
            ...
            <li class="<?php echo ($step == 3) ? 'active' : ''; if($step > 3) echo " done"; ?>">
                <a href="#"><span class="step">3<span class="de_max">/ <?php echo $max ?></span></span> <span class="title"><?php echo ($layout <> 'front') ? app_produto_traducao( 'Termo de Cancelamento', $produto_parceiro_id) : ""; ?></span></a>
            </li>
