...
<style type="text/css">
    ...
    #formulario_conta_bancaria label {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php $this->load->view('admin/venda/partials/enviar_token_acesso_link'); ?>
            </div>

            <div class="modal-footer">
                <? if ( isset($product_parceiro_cancelamento[0]['cancel_via_admin']) && $product_parceiro_cancelamento[0]['cancel_via_admin'] == 1): ?>
                ...
                <?  else:  ?>
                <div style="font-size: 15px;text-align: center;margin: 10px 0 20px 0;color: blue;">
                    Produto só pode ser cancelado via cliente
                </div>
                <?  endif;  ?>
            </div>
        </div>
...
<?php $this->load->view('admin/venda/partials/enviar_token_acesso_modal'); ?>
<!-- FIM MODALS -->
