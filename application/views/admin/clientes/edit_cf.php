                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="hidden" id="<?php echo $field_name ?>" name="<?php echo $field_name; ?>" value='CF' class="required styled"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8"><input class="form-control cpf inputmask-cpf" placeholder="___.___.___-__" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>

                                                    <?php $field_name = 'ie_rg';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">RG</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8"><input  placeholder="__/__/____" class="form-control inputmask-date" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? app_date_mysql_to_mask($row[$field_name]) : set_value($field_name); ?>" /></div>
                                                    </div>
                                                    <?php $field_name = 'titular';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Titular *</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Endereço *</label>
