                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" class="form-control" rows="5"><?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?></textarea>
