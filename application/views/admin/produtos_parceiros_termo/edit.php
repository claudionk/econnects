                                                                ...
                                                                <div class="card tabs-left style-default-light">
                                                                    ...
                                                                    <div class="card-body tab-content style-default-bright">
                                                                        <div id="tabGeral" class="tab-pane active widget-body-regular">
                                                                            <!-- Inicio Vigência -->
                                                                            <?php $field_name = 'produto_parceiro_termo_id';?>
                                                                            <div class="form-group">
                                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Vigência *</label>
                                                                                <div class="col-md-10">
                                                                                <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>" onChange="refresh_termo();">
                                                                                    ...
                                                                                    ?>
                                                                                    <option name="" value="<?php echo $linha['produto_parceiro_termo_id']?>"
                                                                                        <?php 
                                                                                            if(isset($select_vigencia_id)){
                                                                                                if($select_vigencia_id != ""){
                                                                                                    if($linha['produto_parceiro_termo_id'] == $select_vigencia_id && $select == false) {
                                                                            ...
                                                                            <?php $field_name = 'termo';?>
                                                                            <div class="form-group">
                                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Termo *</label>
                                                                                ...
                                                                                <?php echo display_ckeditor($ckeditor_termo); ?>
                                                                            </div>
                                                                </div>
                                                                    </div>
                                                                </div>
