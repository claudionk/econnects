                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="innerB">
                                <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                    <option name="" value="">-- TODOS --</option>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="innerB">
                                <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                    <option name="" value="">-- TODOS --</option>
                                    <?php foreach($comissao_classe as $linha) { ?>
                                        <option name="" value="<?php echo $linha[$field_name] ?>"
                                            <?php if(isset($field_get)){if($field_get == (int)$linha[$field_name]) {echo " selected ";};}; ?> >
                                            <?php echo $linha['nome']; ?>
                                        </option>
                        ...
                        <?php $field_name = 'data_fim'; $field_label = 'Data Fim'; ?>
                        <div class="col-md-2">
                            <h5><?php echo $field_label;?></h5>
                            <div class="innerB">
                                <input class="form-control inputmask-date" id="filter_<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo app_get_value($field_name)?>" />
