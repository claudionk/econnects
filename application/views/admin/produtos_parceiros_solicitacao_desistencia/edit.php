                                                                ...
                                                                <div class="card tabs-left style-default-light">
                                                                    ...
                                                                    <div class="card-body tab-content style-default-bright">
                                                                        <div id="tabGeral" class="tab-pane active widget-body-regular">
                                                                            <!-- Inicio Vigência -->
                                                                            <?php $field_name = 'produto_parceiro_solicitacao_desistencia_id';?>
                                                                            <div class="form-group">
                                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Vigência *</label>
                                                                                <div class="col-md-10">
                                                                                <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>" onChange="refresh_desistencia();">
                                                                                    ...
                                                                                    ?>
                                                                                    <option name="" value="<?php echo $linha['produto_parceiro_solicitacao_desistencia_id']?>"
                                                                                        <?php 
                                                                                            if(isset($select_vigencia_id)){
                                                                                                if($select_vigencia_id != ""){
                                                                                                    if($linha['produto_parceiro_solicitacao_desistencia_id'] == $select_vigencia_id && $select == false) {
                                                                            ...
                                                                            <?php $field_name = 'solicitacao_desistencia';?>
                                                                            <div class="form-group">
                                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Solicitação de Desistencia *</label>
                                                                                ...
                                                                                <?php echo display_ckeditor($ckeditor_solicitacao_desistencia); ?>
                                                                            </div>
                                                                </div>
                                                                    </div>
                                                                </div>
