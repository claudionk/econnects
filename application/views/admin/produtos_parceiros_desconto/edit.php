                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div id="tbDesconto" class="tab-pane active widget-body-regular">
                                        ...
                                        <div class="form-group desconto_habilitado">
                                          ...
                                          <div class="col-md-2">
                                            <input ng-model="valor" ui-number-mask class="form-control" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text"/>
                                          </div>
                                        </div>
                                        <?php $field_name = 'utilizado';?>
                                        <div class="form-group desconto_habilitado">
                                          <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Utilizado</label>
                                          <div class="col-md-2">
                                            <input ng-disabled="true" ng-model="utilizado" ui-number-mask class="form-control" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text"/>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group desconto_habilitado">
                                          ...
                                          <div class="col-md-2">
                                            <input ng-disabled="true" ng-model="saldo" ui-number-mask class="form-control" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" ng-value="valor-utilizado | number: 2 "/>
                                          </div>
                                        </div>
