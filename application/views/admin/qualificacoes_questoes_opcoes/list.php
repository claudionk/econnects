        ...
        <div class="col-md-12">
            ...
            <div class="col-separator col-separator-first col-unscrollable">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-3">
                            <a href="<?php echo base_url("admin/qualificacoes_questoes/view/{$qualificacao_id}")?>" class="btn  btn-app btn-primary">
                                <i class="fa fa-arrow-left"></i> Voltar
                            </a>
                            <a href="<?php echo base_url("$current_controller_uri/add/{$qualificacao_questao_id}")?>" class="btn  btn-app btn-primary">
