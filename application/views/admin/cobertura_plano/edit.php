                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4"><input class="form-control inputmask-moeda2" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" value="<?php echo (isset($row[$field_name]) && !empty($row[$field_name]))  ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>
                                                </div>
                                                <!-- // Column END -->
                                            </div>
