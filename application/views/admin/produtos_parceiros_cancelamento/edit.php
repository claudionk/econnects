                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div id="tabCancelamento" class="tab-pane active widget-body-regular">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <label class="radio-inline radio-styled radio-primary">
                                            <input ng-model="seg_depois_hab" type="radio" id="radio1" name="<?php echo $field_name; ?>" class="required styled"
                                                   value="1" <?php if (isset($row[$field_name]) && $row[$field_name] == '1') echo 'checked="checked"'; ?> />
                                            Sim
                                          </label>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <label class="radio-inline radio-styled radio-primary">
                                            <input ng-model="inad_hab" type="radio" id="radio1" name="<?php echo $field_name; ?>" class="required styled"
                                                   value="1" <?php if (isset($row[$field_name]) && $row[$field_name] == '1') echo 'checked="checked"'; ?> />
                                            Sim
                                          </label>
                                          <label class="radio-inline radio-styled radio-primary">
