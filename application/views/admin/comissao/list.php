                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['comissao_tipo_nome'];?></td>
                                <td class="center">
                                    <?php if($row['comissao_tipo_id'] == 2) : ?>
                                    <a href="<?php echo base_url("admin/comissao_item/index/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-edit"></i>  Itens </a>
                                    <?php endif; ?>
