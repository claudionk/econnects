...
<ul class="card-head nav nav-tabs">
    ...
    <li<?php if (is_current_controller(array('produtos_parceiros_cliente_status'))) : ?> class="active" <?php endif; ?>><a class="glyphicons list" href="<?php echo base_url("admin/produtos_parceiros_cliente_status/index/{$produto_parceiro_id}")?>"><i></i><span>Status</span></a></li>
