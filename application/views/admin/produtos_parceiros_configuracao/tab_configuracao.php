...
<div class="card-body">
    <ul class="nav nav-tabs">
        ...
        <li<?php if (is_current_controller(array('produtos_parceiros_termo', 'produtos_parceiros_apolice', 'produtos_parceiros_apolice_range', 'produtos_parceiros_capitalizacao', 'produtos_parceiros_campos', 'produtos_parceiros_servico'))) : ?> class="active" <?php endif; ?>><a class="glyphicons list" href="<?php echo base_url("admin/produtos_parceiros_termo/edit/{$produto_parceiro_id}")?>"><i></i><span>Produto</span></a></li>
