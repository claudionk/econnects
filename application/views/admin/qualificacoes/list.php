                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th class="center" width='70%'>Ações</th>
                            </tr>
                            </thead>
                            <!-- // Table heading END -->
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a href="<?php echo base_url("admin/qualificacoes_parceiros/view/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-edit"></i>  Parceiros </a>
                                    <a href="<?php echo base_url("admin/qualificacoes_questoes/view/{$row[$primary_key]}")?>" class="btn btn-sm btn-primary">  <i class="fa fa-edit"></i>  Questões </a>
                                    <a href="<?php echo base_url("{$current_controller_uri}/ranking/{$row[$primary_key]}")?>" class="btn btn-sm btn-success">  <i class="fa fa-edit"></i>  Ranking </a>
