            ...
            <div class="col-separator col-separator-first col-unscrollable">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo base_url("$current_controller_uri/add/{$cliente_id}")?>" class="btn  btn-app btn-primary">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php  foreach($rows as $row) :?>
                                <tr>
                                    ...
                                    <td><?php if($row['decisor'] == 1) echo "Sim"; else echo "Não";?></td>
                                    <td class="center">
