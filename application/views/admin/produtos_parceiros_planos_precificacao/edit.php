    ...
    <div class="row row-app">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- Widget heading -->
                <div class="card-body">
                    <a href="<?php echo base_url("admin/produtos_parceiros_planos/view_by_produto_parceiro/{$produto_parceiro_plano['produto_parceiro_id']}")?>" class="btn  btn-app btn-primary">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h3 class="panel-title">Precificação - <?php echo $precificacao_tipo['nome']; ?></h3>
                                                        </div>
                                                        <div class="panel-body">
                                                            ...
                                                            <?php if($produto_parceiro_plano['precificacao_tipo_id'] == 2) :  ?>
                                                                <?php $field_name = 'valor';?>
                                                                <div class="form-group">
                                                                    <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Porcentagem por cobertura (%) *</label>
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if($produto_parceiro_plano['precificacao_tipo_id'] == 3) :  ?>
                                                                <?php $field_name = 'valor';?>
                                                                <div class="form-group">
...
<!--
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <h3 class="panel-title">Dados de Comissão - <?php echo $comissao_tipo['nome']?></h3>
                                                        </div>
                                                        <div class="panel-body">
                                                            ...
                                                            <?php $field_name = 'comissao_minima';?>
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Comissão mínima (%) *</label>
                                                                <div class="col-md-8"><input class="form-control inputmask-moeda" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                            </div>

                                                            <?php $field_name = 'comissao_maxima';?>
                                                            <div class="form-group">
                                                                <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Comissão máxima (%) *</label>
                                                                <div class="col-md-8"><input class="form-control inputmask-moeda" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                            </div>
                                                        </div>
                                                    </div>
