                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    -->
                                                    <input type="hidden" name="parceiro_id" value="0">
                                                    ...
                                                    <?php $field_name = 'foto';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Foto</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <hr>
                                                    <br>
                                                    <?php $field_name = 'telefone';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Telefone *</label>
                                                        <div class="col-md-8"><input class="form-control inputmask-telefone" placeholder="(__)________" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>

                                                    <?php $field_name = 'celular';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Celular *</label>
                                                        <div class="col-md-8"><input class="form-control inputmask-telefone" placeholder="(__)_________" id="<?php echo $field_name ?>" name="<?php echo $field_name ?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>
                                                    ...
                                                    <br>
                                                    <h4>Acesso aos parceiros</h4>
                                                    <hr>

                                                    <p>Selecione os parceiros em que o usuário terá acesso.</p>

                                                    <?php foreach($parceiro as $p) { ?>

                                                        <label class="checkbox-inline checkbox-styled">
                                                            <input type="checkbox" <?php if(isset($p['selecionado']) && $p['selecionado']) {echo 'checked="true"';} ?> name="colaborador_parceiro[]" value="<?php echo $p['parceiro_id'] ?>">
