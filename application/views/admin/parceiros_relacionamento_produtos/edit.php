                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group desconto_habilitado">
                                                                ...
                                                                <div class="col-md-4"><input class="form-control inputmask-valor" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                            </div>
                                                            <?php $field_name = 'desconto_utilizado';?>
                                                            <div class="form-group desconto_habilitado">
                                                                <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Utlizado</label>
                                                                <div class="col-md-4"><input readonly class="form-control inputmask-valor" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                            </div>
                                                            <?php $field_name = 'desconto_saldo';?>
                                                            <div class="form-group desconto_habilitado">
                                                                <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Saldo</label>
                                                                <div class="col-md-4"><input readonly class="form-control inputmask-valor" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo (isset($row['desconto_valor']) ) ? (app_format_currency(($row['desconto_valor'] - $row['desconto_utilizado']), false, 2)) : '000,00'; ?>" /></div>
                                                            </div>
