...
<?php $this->load->view("admin/pedido_upgrade/search_form"); ?>
<!-- Widget -->
<div class="card">
    <div class="card-body">
        <!-- Table -->
        <table class="table table-hover">
            ...
            <?php foreach($rows as $row) :?>
                <?php $status = ($row['pedido_status_id'] == 5) ? ' class="danger"' : '' ?>
                <tr<?php echo $status; ?>>
                    ...
                    <td class="center">
                        <a href="<?php echo admin_url("pedido_upgrade/view/{$row[$primary_key]}") ?>" class="btn btn-sm btn-primary">  <i class="fa fa-edit"></i>  Visualizar </a>
                    </td>
                </tr>
