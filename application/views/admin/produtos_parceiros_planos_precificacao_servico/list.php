            ...
            <div class="col-separator col-separator-first col-unscrollable">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo app_assets_url("arquivos/exemplo-precificacao-servico.xlsx", "common")?>" class="btn  btn-app btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th width='10%'>Quantidade Mínima</th>
                            ...
                            <?php foreach($rows as $row) :?>
                                <tr>
                                    <td><?php echo $row['servico_produto_nome'];?></td>
                                    <td><?php echo $row['servico_produto_unidade'];?></td>
                                    <td><?php echo $row['servico_produto_quantidade_minima'];?></td>
