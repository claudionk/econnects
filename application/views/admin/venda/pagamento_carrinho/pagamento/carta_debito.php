    ...
    <div class="col-md-6">
        ...
        <div class="form-group<?php echo (app_is_form_error('numero_debito')) ? ' has-error' : ''; ?><?php echo (app_is_form_error('numero_debito')) ? ' has-error' : ''; ?>">
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" placeholder="Número do Catão" id="numero_debito" name="numero_debito" type="text" value="<?php echo isset($row['numero_debito']) ? $row['numero_debito'] : set_value('numero_debito'); ?>" />
