...
<div class="card">
    <div class="card-body">
        <a href="<?php echo base_url("{$current_controller_uri}/seguro_viagem/41/1/$cotacao_id") ?>"
        ...
        <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h4>Cotação do Seguro Viagem</h4>

                    <?php if ($cotacao_id > 0) : ?>
                        <br>
                        <p>Código da Cotação: <span class="strong"><?php echo $cotacao_codigo; ?></span></p>
                        <br>
                    <?php endif; ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-xs-6 no-padding">
                                        <div class="vendas_bloco_left carrossel-left">
                            ...
                            <div class="row">
                                <div class="col-xs-6 no-padding">
                                    <div class="col-xs-6  carrossel-left">
                                    ...
                                    <div class="col-xs-6 no-padding carrossel-right">
                                        <div class="comissao_row">
                                            <ul>
                                                <!--
                                                <li>Até 65 anos</li>
                                                <li>65 a 70 anos</li>-->
                                                <li style="">Data de saída</li>
                                                <li style="">Data de retorno</li>
                                                <li style="">Quantidade de dias</li>
                                                <li style="font-weight: bold;">Passageiros</li>
                                                <li style="font-weight: bold;"><?php echo $label_valor_bruto; ?></li>
                                                <?php if ($exite_cobertura) : ?>
                                                    <li>Coberturas adicionais</li>
                                                <?php endif; ?>
                                                <li>Comissão</li>
                                                <?php if ($configuracao['repasse_comissao'] == 1) : ?>
                                                    <li>Repasse de Comissão</li>
                                                <?php endif; ?>
                                                <li style="font-weight: bold;">Comissão do Corretor</li>
                                                <?php if ($desconto['habilitado']) : ?>
                                                    <li>Desconto Condicional</li>
                                                <?php endif; ?>
                                                <li style="text-transform: uppercase; font-weight: bold;">PRÊMIO LÍQUIDO</li>
                                                ...
                                                <?php if($desconto_upgrade == 1) : ?>
                                                    <li>DESCONTO UPGRADE</li>
                                                <?php endif;?>
                                                <li style="text-transform: uppercase; font-weight: bold;">PRÊMIO LÍQUIDO TOTAL</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <li class="">
                                                            ...
                                                            <table class="preco_table">
                                                                ...
                                                                <tr class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text" class="inputmask-date data_saida" id="data_saida_one_<?php echo $plano['produto_parceiro_plano_id']; ?>" name="data_saida_one_<?php echo $plano['produto_parceiro_plano_id']; ?>" value="<?php echo $cotacao['data_saida']; ?>"></td>
                                                                </tr>
                                                                <tr class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text" class="inputmask-date data_retorno" id="data_retorno_one_<?php echo $plano['produto_parceiro_plano_id']; ?>" name="data_retorno_one_<?php echo $plano['produto_parceiro_plano_id']; ?>" value="<?php echo $cotacao['data_retorno']; ?>"></td>
                                                                </tr>

                                                                <tr class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td class="quantidade_dias"><?php echo $quantidade_dias; ?></td>
                                                                </tr>

                                                                <tr class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text"
                                                                               class="num_passageiro inputmask-numero"
                                                                               id="num_passageiro_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                                               name="num_passageiro_one_<?php echo $plano['produto_parceiro_plano_id']; ?> "
                                                                               value="<?php if (isset($carrossel['num_passageiro'])) {
                                                                                   echo $carrossel['num_passageiro'];
                                                                               } else {
                                                                                   echo '1';
                                                                               } ?>"></td>
                                                                </tr>
                                                    ...
                                                    <?php foreach ($planos as $plano): ?>
                                                        <li class="">
                                                            ...
                                                            <table class="preco_table">
                                                                ...
                                                                <tr  class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text" class="inputmask-date data_saida" id="data_saida_two_<?php echo $plano['produto_parceiro_plano_id']; ?>" name="data_saida_two_<?php echo $plano['produto_parceiro_plano_id']; ?>" value="<?php echo $cotacao['data_saida']; ?>"></td>
                                                                </tr>
                                                                <tr  class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text" class="inputmask-date data_retorno" id="data_retorno_two_<?php echo $plano['produto_parceiro_plano_id']; ?>" name="data_retorno_two_<?php echo $plano['produto_parceiro_plano_id']; ?>" value="<?php echo $cotacao['data_retorno']; ?>"></td>
                                                                </tr>
                                                                ...
                                                                <tr  class="<?php if($div%2==0) {echo 'odd';} $div++;  ?>">
                                                                    <td><input type="text"
                                                                               class="num_passageiro inputmask-numero"
                                                                               id="num_passageiro_two_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                                               name="num_passageiro_two_<?php echo $plano['produto_parceiro_plano_id']; ?> "
                                                                               value="<?php if (isset($carrossel['num_passageiro'])) {
                                                                                   echo $carrossel['num_passageiro'];
                                                                               } else {
                                                                                   echo '1';
                                                                ...
                                                                <tr>
                                                                    <td class="td-add-car"><a class="add-car"
                                                                                              ...
                                                                                              data-plano="<?php echo $plano['produto_parceiro_plano_id']; ?>">Adicionar
                                                                            Carrinho</a></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" id="num_passageiro" name="num_passageiro"
                                           value="<?php if (isset($carrinho_hidden['num_passageiro'])) echo $carrinho_hidden['num_passageiro']; ?>"/>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php foreach ($carrinho as $item) : ?>
                                                ...
                                                <tr class="plano-carrinho-<?php echo $item['plano_id']; ?>">
                                                    ...
                                                    <td><?php echo $item['passageiro']; ?></td>
