                                        ...
                                        <ul class="list-unstyled">
                                            <li class="row cobertura">
                                                <div class="form-group col-md-8">
                                                    <label class="control-label" for="quantidade_one_<?php echo $plano['produto_parceiro_plano_id']; ?>">Saída:</label>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <input type="text"
                                                           class="inputmask-date data_saida"
                                                           id="data_saida_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                           name="data_saida_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                           value="<?php echo $cotacao['data_saida']; ?>">
                                                </div>
                                            </li>

                                            <li class="row cobertura">
                                                <div class="form-group col-md-8">
                                                    <label class="control-label" for="quantidade_one_<?php echo $plano['produto_parceiro_plano_id']; ?>">Retorno:</label>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <input type="text"
                                                           class="inputmask-date data_retorno"
                                                           id="data_retorno_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                           name="data_retorno_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                                           value="<?php echo $cotacao['data_retorno']; ?>">
                                                </div>
                                            </li>
                                            ...
                                            <li class="row cobertura">
                                                <div class="form-group col-md-8">
                                                    <label class="control-label" for="quantidade_one_<?php echo $plano['produto_parceiro_plano_id']; ?>">Passageiros:</label>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <input type="text"
...
<div class="card">
    <div class="card-body">
        ...
        <a href="<?php echo base_url("{$current_controller_uri}/generico/{$row['produto_parceiro_id']}/1/$cotacao_id") ?>"
