    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            <div class="col-xs-12">
                ...
                <input class="form-control inputmask-cpf" id="sacado_documento" name="sacado_documento" value="<?php echo isset($row['sacado_documento']) ? $row['sacado_documento'] : set_value('sacado_documento'); ?>" />
            ...
            <div class="col-xs-12">
                <label for="sacado_endereco_uf" class="control-label">Estado</label>
