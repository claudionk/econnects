        ...
        <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h2 class="text-light text-center"><?php echo app_produto_traducao('Cotação de Seguro', $row['produto_parceiro_id']); ?><br><small class="text-primary"><?php echo app_produto_traducao('Selecione o plano e as coberturas que você deseja!', $row['produto_parceiro_id']); ?></small></h2>
                                ...
                                <div class="card card-type-pricing text-center">
                                        ...
                                        <ul class="list-unstyled">
                                            <?php if(app_has_config_campo('servico_produto', $row['produto_parceiro_id'])) :  ?>
                                                <li class="row cobertura">
                                                    <div class="col-md-6 no-padding"><?php echo app_produto_traducao('Produto / Serviço', $row['produto_parceiro_id']); ?></div>
                                                    <div class="col-md-6 no-padding"><?php echo isset($servico_produto['nome']) ? $servico_produto['nome'] : '---';?></div>
                                                </li>
                                                <li class="row cobertura">
                                                    <div class="col-md-6 no-padding"><?php echo app_produto_traducao('Unidade de venda', $row['produto_parceiro_id']); ?></div>
                                                    <div class="col-md-6 no-padding"><?php echo isset($servico_produto['unidade']) ? $servico_produto['unidade'] : '---';?></div>
                                                </li>
                                                <li class="row cobertura">
                                                    <div class="col-md-6 no-padding"><?php echo app_produto_traducao('Quantidade Mínima', $row['produto_parceiro_id']); ?></div>
                                                    <div class="col-md-6 no-padding"><?php echo isset($servico_produto['quantidade_minima']) ? $servico_produto['quantidade_minima'] : '0';?></div>
                                                </li>
                                            <?php endif; ?>
                                            ...
                                            <?php if(app_has_config_campo('cotacao_quantidade', $row['produto_parceiro_id'])) :  ?>
                                                <li class="row cobertura">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <input type="text"
                                                                   class="form-control quantidade inputmask-numero quantidade_one_<?php echo $plano['produto_parceiro_plano_id']; ?>"
                                    ...
                                    <div class="card-body">
                                        <a class="btn btn-primary add-car" href="javascript: void(0);" data-plano="<?php echo $plano['produto_parceiro_plano_id']; ?>">
                                            <?php echo app_produto_traducao('Escolher este plano', $row['produto_parceiro_id']); ?>
                                        </a>
                                    </div><!--end .card-body -->
                                </div><!--end .card -->
                            </div><!--end .col -->
