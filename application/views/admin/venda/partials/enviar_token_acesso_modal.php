        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Envio para <?php echo ($exibe_url_acesso_externo_tipo == 'cancelamento') ? 'pagamento' : 'cancelamento' ?> externo</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="bt_enviar_email" class="btn btn-primary"><i class="fa fa-mail-forward"></i> Enviar URL por e-mail</button>
                    <button type="button" id="bt_enviar_sms" class="btn btn-primary"><i class="fa fa-mail-forward"></i> Enviar URL por SMS</button>
