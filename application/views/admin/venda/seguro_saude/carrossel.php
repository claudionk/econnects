                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <?php if(count($coberturas) > 0) : ?>
                                <h4><?php echo app_produto_traducao('Comparar os planos disponíveis', $row['produto_parceiro_id']); ?></h4>

                                <div class="row">
                                    <div class="col-sm-6"></div>
                                    <div class="col-sm-6" id="click_comparar_cotacoes">
                                        <i class="fa fa-arrow-down text-primary"></i>
                                        <?php echo app_produto_traducao('Clique aqui para comparar as demais cotações', $row['produto_parceiro_id']); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                                    ...
                                    <div class="col-xs-6 no-padding">
                                        <div class="comissao_row">
                                            <ul>
                                                ...
                                                <?php endif; ?>
                                                <?php if( $configuracao["calculo_tipo_id"] == 1 ) : ?>
                                                ...
                                                <?php endif;?>
                                                <li class="li_premio_liquido_total" style="text-transform: uppercase; font-weight: bold;"><?php echo app_produto_traducao('PRÊMIO TOTAL DE SEGURO', $row['produto_parceiro_id']); ?></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-6 carrossel-right">
                                    <div class="vendas_bloco_right">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php foreach ($carrinho as $item) : ?>
                                                ...
                                                <tr class="plano-carrinho-<?php echo $item['plano_id']; ?>">
                                                    <td style="text-align:center"><?php echo $item['item']; ?></td>
                                                    <td><?php echo $item['plano']; ?></td>
                                                    <td style="text-align:center"><?php echo isset($item['quantidade']) ? $item['quantidade'] : '1'; ?></td>
