...
<div class="card">
    ...
    <div class="card-body">
        <div class="box-sucesso" style="display: none">
            ...
            <a class="btn  btn-app btn-primary" href="<?php echo base_url("{$current_controller_uri}/seguro_saude/{$produto_parceiro_id}/6/{$pedido_id}"); ?>" >
                <i class="fa fa-edit"></i> Emissão Certificado
            </a>
        </div>

        <div class="innerAll  bg-white box-erro" style="display: none">
            <a href="<?php echo base_url("{$current_controller_uri}/seguro_saude/{$produto_parceiro_id}/4/{$pedido['cotacao_id']}/{$pedido_id}"); ?>" class="btn  btn-app btn-primary">
