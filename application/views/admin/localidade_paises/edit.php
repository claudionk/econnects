                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php $field_name = 'localidade_continente_id';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Continente</label>
                                                        <div class="col-md-8">
                                                            <?php echo app_get_select_html($field_name, 'nome', $continentes, issetor($row[$field_name]), 'chave', 'Selecione', 'style="width: 100%;" class="form-control"'); ?>
                                                        </div>
                                                    </div>
