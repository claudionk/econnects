...
<html lang="en">
    ...
    <body id="body-login">
        ...
        <div id="form-login-container">
            <form id="form-login" class="form" action="<?php echo $envia_codigo_url;?>" accept-charset="utf-8" method="post">
                <h2 id="form-login-title"><b>ENTRE COM SEU EMAIL</b></h2>
                <p style="margin-bottom: 0px; color: #FFF;">Um codigo sera enviado para o seu e-mail</p>
                <div class="form-login-group">
                    <input type="email" class="form-control form-login-input" id="useremail" name="email" />
                    <label class="form-login-label">DIGITE SEU EMAIL</label>
                </div>
                </br>
                <div class="row">
                    <div class="col-xs-12 text-left">
                        <p id="form-login-mensagem"><?php echo $this->session->flashdata('email_erro');?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-4 text-right">
                        <button id="form-login-submit" type="submit" >ENVIAR</button>
                    </div>
                </div>
            </form>
        </div>
