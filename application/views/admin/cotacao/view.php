        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url("admin/venda/continuar/{$row[$primary_key]}")?>" class="btn  btn-app btn-primary">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php if($row['produto_slug'] == 'seguro_viagem') : ?>
                                                    <?php foreach ($produto as $viagem) : ?>
                                                        <br>
                                                    ...
                                                    <?php endforeach; ?>
                                                    <?php elseif($row['produto_slug'] == 'equipamento') : ?>
                                                        <br>
                                                        <h4>PLANO: <?php echo $produto['produto_nome']; ?></h4>
                                                        <hr>
                                                        <br>

                                                        <?php $field_name = 'motivo';?>
                                                        <?php if(isset($produto[$field_name]) && !empty($produto[$field_name])) :?>

                                                            <div class="form-group">
                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Motivo:</label>
                                                                <div class="col-md-8"><input class="form-control" readonly id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($produto[$field_name]) ? $produto[$field_name] : set_value($field_name); ?>" /></div>
                                                            </div>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(isset($produto[$field_name]) && !empty($produto[$field_name])) :?>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Repasse Comissão (%):</label>
                                                                <div class="col-md-3"><input class="form-control" readonly id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($produto[$field_name]) ? app_format_currency($produto[$field_name]) : set_value($field_name); ?>" /></div>
                                                                <?php $field_name = 'comissao_corretor';?>
                                                                <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Comissão (%):</label>
                                                                <div class="col-md-3"><input class="form-control" readonly id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($produto[$field_name]) ? app_format_currency($produto[$field_name])  : set_value($field_name); ?>" /></div>
                                                            </div>
                                                    ...
                                                    <?php elseif($row['produto_slug'] == 'generico') : ?>
                                                        <br>
                                                        <h4>PLANO: <?php echo $produto['produto_nome']; ?></h4>
                                                        <hr>
                                                        <br>
