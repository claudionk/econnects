                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Régua Lógica</label>
                                                        <div class="col-md-3">
                                                            <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                                                <option  value="">Selecione</option>
                                                                <?php

                                                                foreach($reguas_logica as  $linha_value => $linha_name) { ?>
                                                                    <option  value="<?php echo $linha_value ?>"
                                                                        <?php if(isset($row[$field_name])){if($row[$field_name] == $linha_value) {echo " selected ";};}; ?> >
                                                                        <?php echo $linha_name; ?> de <?php echo $linha_name; ?>
                                                                    </option>
                                                                <?php }  ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Régua Valor</label>
                                                        <div class="col-md-3">
                                                            <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                                                <option  value="">Selecione</option>
                                                                <?php

                                                                foreach($reguas_valor as  $linha_value => $linha_name) { ?>
                                                                    <option  value="<?php echo $linha_value ?>"
                                                                        <?php if(isset($row[$field_name])){if($row[$field_name] == $linha_value) {echo " selected ";};}; ?> >
                                                                        <?php echo $linha_name; ?>
                                                                    </option>
                                                    ...
                                                    <?php $field_name = 'pontos';?>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Pontos</label>
