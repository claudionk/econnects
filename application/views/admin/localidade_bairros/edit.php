                        ...
                        <div class="col-app col-unscrollable">
                            ...
                            <div class="col-app">
                                ...
                                <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off">
                                    ...
                                    <input type="hidden" name="cidade_id" id="cidade_id" value="<?php if (isset($row['localidade_cidade_id'])) echo $row['localidade_cidade_id']; ?>"/>
                                    <!-- Widget -->
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Estado / Cidade *</label>
                                                        <div class="col-md-4">
                                                            <select class="form-control" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                                                ...
                                                                foreach($estados as $linha) { ?>
                                                                    <option name="" value="<?php echo $linha[$field_name] ?>" 
                                                                        ...
                                                                        <?php if(isset($row['localidade_cidade_localidade_estado_id'])){if($row['localidade_cidade_localidade_estado_id'] == $linha[$field_name]) {echo " selected ";};}; ?>
                                                                        >
                                                                        <?php echo $linha['nome']; ?>
                                                                    </option>
                                                                <?php }  ?>
