    ...
    <div class="row row-app">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- Widget heading -->
                <div class="card-body">
                    <a href="<?php echo base_url("{$current_controller_uri}/index/{$moeda_id}")?>" class="btn  btn-app btn-primary">
                        ...
                        <div class="col-app col-unscrollable">
                            ...
                            <div class="col-app">
                                ...
                                <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off">
                                    ...
                                    <input type="hidden" name="moeda_id" value="<?php if (isset($moeda_id)) echo $moeda_id; ?>"/>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php $field_name = 'data_cambio';?>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="<?php echo $field_name;?>">Data *</label>
