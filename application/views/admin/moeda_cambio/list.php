        ...
        <div class="col-md-12">
            ...
            <div class="col-separator col-separator-first col-unscrollable">
                <div class="card">
                    ...
                    <!-- Widget heading -->
                    <div class="card-body">
                        <a href="<?php echo base_url("admin/moeda/index/")?>" class="btn  btn-app btn-primary">
                            <i class="fa fa-arrow-left"></i> Voltar
                        </a>
                        <a href="<?php echo base_url("$current_controller_uri/add/{$moeda_id}")?>" class="btn  btn-app btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo app_dateonly_mysql_to_mask($row['data_cambio']); ?></td>
                                <td><?php echo app_format_currency($row['valor_real'], false, 3); ?></td>
                                <td class="center">
