...
class Apolice extends CI_Controller {
    ...
    public function cancelar() {
        ...
        $define_data = !empty( $validacao['dados']["define_data"] ) ? $validacao['dados']["define_data"] : date("Y-m-d");

        //pega as configurações de cancelamento do pedido
        $produto_parceiro_cancelamento = $this->pedido->cancelamento( $pedido_id, $dados_bancarios,$define_data);
    ...
    public function calculoCancelar() {
        ...
        //pega as configurações de cancelamento do pedido
        $produto_parceiro_cancelamento = $this->pedido->cancelamento_calculo( $pedido_id , $define_data );
