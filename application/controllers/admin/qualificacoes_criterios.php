...
/**
 * Class Qualificacoes_Criterios
 *
 * @property Qualificacao_Criterio_Model $current_model
 *
 */
class Qualificacoes_Criterios extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Critérios");
        $this->template->set_breadcrumb("Critérios", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('qualificacao_criterio_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Critérios");
        $this->template->set_breadcrumb("Critérios", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Critério");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Critério");
        $this->template->set_breadcrumb('Critério', base_url("$this->controller_uri/index"));
