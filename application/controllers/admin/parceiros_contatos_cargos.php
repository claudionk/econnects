...
/**
 * Class Parceiros_Contatos_Cargos
 *
 * @property Parceiro_Contato_Cargo_Model $current_model
 *
 */
class Parceiros_Contatos_Cargos extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Parceiros / Contatos / Cargos");
        $this->template->set_breadcrumb("Parceiros / Contatos / Cargos", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('parceiro_contato_cargo_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Parceiros / Contatos  / Cargos");
