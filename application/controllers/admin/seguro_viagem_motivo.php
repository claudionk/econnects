 ...
 *
 */
class Seguro_Viagem_Motivo extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Motivo de Viagem");
        $this->template->set_breadcrumb("Motivo de Viagem", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('seguro_viagem_motivo_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Motivo de Viagem");
        $this->template->set_breadcrumb("Motivo de Viagem", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Motivo de Viagem");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Motivo de Viagem");
