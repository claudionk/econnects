 ...
 *
 */
class Cobranca_Item extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Cobrança Item");
        $this->template->set_breadcrumb("Cobrança Item", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('cobranca_item_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Cobrança Item");
        $this->template->set_breadcrumb("Cobrança Item", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Cobrança Item");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Cobrança Item");
