...
/**
 * Class Qualificacoes_Reguas
 *
 * @property Qualificacao_Regua_Model $current_model
 *
 */
class Qualificacoes_Reguas extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Réguas");
        $this->template->set_breadcrumb("Réguas", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('qualificacao_regua_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Réguas");
        $this->template->set_breadcrumb("Réguas", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Régua");
        ...
        $data['reguas_logica'] = $this->current_model->get_regua_logica_options();
        $data['reguas_valor'] = $this->current_model->get_regua_valor_options();
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Régua");
