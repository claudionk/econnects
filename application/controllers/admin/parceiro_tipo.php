 ...
 *
 */
class Parceiro_Tipo extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Tipo de Parceiro");
        $this->template->set_breadcrumb("Tipo de Parceiro", base_url("$this->controller_uri/index"));
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Tipo de Parceiro");
        $this->template->set_breadcrumb("Tipo de Parceiro", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Tipo de Parceiro");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Tipo de Parceiro");
