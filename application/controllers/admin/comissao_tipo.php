 ...
 *
 */
class Comissao_Tipo extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Tipo de Comissão");
        $this->template->set_breadcrumb("Tipo de Comissão", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('comissao_tipo_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Tipo de Comissão");
        $this->template->set_breadcrumb("Tipo de Comissão", base_url("$this->controller_uri/index"));
