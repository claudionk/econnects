 ...
 *
 */
class Parceiros_Status extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Status de Parceiros");
        $this->template->set_breadcrumb("Status de Parceiros", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('parceiro_status_model', 'current_model');
