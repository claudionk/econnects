 ...
 *
 */
class Produtos_parceiros_autorizacao_cobranca extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Produto / Parceiros / Autorização de Cobrança");
        $this->template->set_breadcrumb("Produtos / Parceiros / Autorização de Cobrança", base_url("$this->controller_uri/edit"));

        //Carrega modelos
        $this->load->model('produto_parceiro_autorizacao_cobranca_model', 'current_model');
     ...
     public function edit($produto_parceiro_id) //Função que edita registro
    {
        ...
        $this->auth->check_permission('view', 'produtos_parceiros_autorizacao_cobranca', 'admin/produtos_parceiros/');
        ...
        $this->template->js(app_assets_url('modulos/produtos_parceiros_autorizacao_cobranca/base.js', 'admin'));
        ...
        $data['ckeditor_autorizacao_cobranca'] = array
        (
            'id'   => 'autorizacao_cobranca',
