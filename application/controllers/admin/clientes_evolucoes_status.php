 ...
 *
 * @property Evolucao_Status $current_model
 *
 */
class Clientes_Evolucoes_Status extends Admin_Controller
{
    public function __construct()
    {
        ...
        $this->template->set('page_title', 'Status de evolução');
        $this->template->set_breadcrumb('Status de evolução', base_url("$this->controller_uri/index"));
        
        //Carrega modelos necessários
        $this->load->model('cliente_evolucao_status_model', 'current_model');
    }
    ...
    public function index($offset = 0)
    {
        ...
        $this->template->set('page_subtitle', 'Status de evoluções');
        $this->template->set_breadcrumb('Status de evoluções', base_url("$this->controller_uri/index"));
    ...
    {   
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Adicionar Status de Evolução');
    ...
    public function edit($id)
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Editar Status de Evolução');
