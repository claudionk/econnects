 ...
 */
class comunicacao_engine_configuracao extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Configuração de Engine de comunicação");
        $this->template->set_breadcrumb("Integrações", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('comunicacao_engine_configuracao_model', 'current_model');
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Configuração de Engine de comunicação");
        $this->template->set_breadcrumb("Configuração de Engine de comunicação", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Configuração de Engine de comunicação");
        ...
        $data['comunicacao_engines'] = $this->comunicacao_engine->get_all();
    ...
    public function edit($id)
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Configuração de Engine de comunicação");
