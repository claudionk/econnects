 ...
 *
 */
class Contato_Tipo extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Tipo de Contato");
        $this->template->set_breadcrumb("Tipo de Contato", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('contato_tipo_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Tipo de Contato");
        $this->template->set_breadcrumb("Tipo de Contato", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Tipo de Contato");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Tipo de Contato");
