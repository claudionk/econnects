 ...
 *
 * @property Nivel_Relacionamento $current_model
 *
 */
class Clientes_Contatos_Niveis_Relacionamento extends Admin_Controller
{
    public function __construct()
    {
        ...
        $this->template->set('page_title', 'Nivel Relacionamento');
        $this->template->set_breadcrumb('Nivel Relacionamento', base_url("$this->controller_uri/index"));
        
        //Carrega modelos necessários
        $this->load->model('cliente_contato_nivel_relacionamento_model', 'current_model');
    }
    ...
    public function index($offset = 0)
    {
        ...
        $this->template->set('page_subtitle', 'Níveis de Relacionamentos');
        $this->template->set_breadcrumb('Níveis de Relacionamentos', base_url("$this->controller_uri/index"));
    ...
    {   
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Adicionar Nível de Relacionamento');
    ...
    public function edit($id)
    {
      //Carrega bibliotecas necessesárias
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Editar Nível de Relacionamento');
