 ...
 *
 */
class Capitalizacao_Sorteio extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Capitalização Sorteio");
        $this->template->set_breadcrumb("Capitalização Sorteio", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('capitalizacao_sorteio_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Capitalização Sorteio");
        $this->template->set_breadcrumb("Capitalização Sorteio", base_url("$this->controller_uri/index"));
