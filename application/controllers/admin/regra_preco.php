 ...
 *
 */
class Regra_Preco extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Regra de Preços");
        $this->template->set_breadcrumb("Regra de Preços", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('regra_preco_model', 'current_model');
    }
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Regra de Preço");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Regra de Preço");
