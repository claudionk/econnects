 ...
 *
 */
class Fatura_Status extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Status da Fatura");
        $this->template->set_breadcrumb("Status da Fatura", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('fatura_status_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Status da Fatura");
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Status da Fatura");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Status da Fatura");
