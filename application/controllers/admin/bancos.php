 ...
 *
 */
class Bancos extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Bancos");
        $this->template->set_breadcrumb("Bancos", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('banco_model', 'current_model');
    }
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Bancos");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Bancos");
