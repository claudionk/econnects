 ...
 *
 */
class Faixa_Salarial extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Faixa Salarial");
        $this->template->set_breadcrumb("Faixa Salarial", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('faixa_salarial_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Faixa Salarial");
        $this->template->set_breadcrumb("Faixa Salarial", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Faixa Salarial");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Faixa Salarial");
