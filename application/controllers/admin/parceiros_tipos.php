...
/**
 * Class Parceiros_Tipos
 *
 * @property Parceiro_Tipo_Model $current_model
 *
 */
class Parceiros_Tipos extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Tipos de  Parceiros");
        $this->template->set_breadcrumb("Tipos de Parceiros", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('parceiro_tipo_model', 'current_model');
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Tipo");
        $this->template->set_breadcrumb("Tipos", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Tipo");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Tipo");
