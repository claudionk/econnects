...
/**
 * Class Localidade_Estados
 *
 * @property Localidade_Estados $current_model
 *
 */
class Localidade_Estados extends Admin_Controller 
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Estados");
        $this->template->set_breadcrumb("Estados", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('localidade_estado_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Estados");
        $this->template->set_breadcrumb("Estados", base_url("$this->controller_uri/index"));
        
        //Carrega modelos necessários
        $this->load->model('localidade_pais_model','paises');
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Estado");
        ...
        $data['paises'] = $this->paises->get_all();
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Estado");
