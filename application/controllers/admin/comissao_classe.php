 ...
 *
 */
class Comissao_Classe extends Admin_Controller
{
    public function __construct() 
    {
        ...
        $this->template->set('page_title', "Classe de Comissão");
        $this->template->set_breadcrumb("Classe de Comissão", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('comissao_classe_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Classe de Comissão");
        $this->template->set_breadcrumb("Classe de Comissão", base_url("$this->controller_uri/index"));
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Classe de Comissão");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Classe de Comissão");
