...
/**
 * Class Produtos_Ramos
 *
 * @property Produto_Ramo_Model $current_model
 *
 */
class Produtos_Ramos extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Ramos");
        $this->template->set_breadcrumb("Ramos", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('produto_ramo_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Ramos");
        $this->template->set_breadcrumb("Ramos", base_url("$this->controller_uri/index"));
