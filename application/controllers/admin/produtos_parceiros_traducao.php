 ...
 *
 */
class Produtos_Parceiros_Traducao extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Produtos / Parceiro / Tradução");
        $this->template->set_breadcrumb("Produtos / Parceiro / Tradução", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('produto_parceiro_traducao_model', 'current_model');
    ...
    public function index($produto_parceiro_id , $offset = 0)
    {
        ...
        $this->auth->check_permission('view', 'produto_parceiro_traducao', 'admin/parceiros/');
        ...
        $this->template->set('page_subtitle', "Tradução");
        $this->template->set_breadcrumb("Tradução", base_url("$this->controller_uri/view_by_produto_parceiro/{$produto_parceiro_id}"));
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Tradução");
        $this->template->set_breadcrumb('Tradução', base_url("$this->controller_uri/index"));
