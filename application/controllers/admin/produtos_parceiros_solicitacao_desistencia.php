 ...
 *
 */
class Produtos_parceiros_solicitacao_desistencia extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Produto / Parceiros / Solicitação de Desistencia");
        $this->template->set_breadcrumb("Produtos / Parceiros / Solicitação de Desistencia", base_url("$this->controller_uri/edit"));

        //Carrega modelos
        $this->load->model('produto_parceiro_solicitacao_desistencia_model', 'current_model');
     ...
     public function edit($produto_parceiro_id) //Função que edita registro
    {
        ...
        $this->auth->check_permission('view', 'produtos_parceiros_solicitacao_desistencia', 'admin/produtos_parceiros/');
        ...
        $this->template->set('page_subtitle', "Produto / Parceiro / Autorização de Cobrança");
        $this->template->set_breadcrumb('Produto / Parceiro / Autorização de Cobrança', base_url("$this->controller_uri/index"));
        $this->template->js(app_assets_url('modulos/produtos_parceiros_solicitacao_desistencia/base.js', 'admin'));
        ...
        $data['ckeditor_solicitacao_desistencia'] = array
        (
            'id'   => 'solicitacao_desistencia',
