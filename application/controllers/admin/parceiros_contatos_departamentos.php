...
/**
 * Class Parceiros_Contatos_Departamentos
 *
 * @property Parceiro_Contato_Departamento_Model $current_model
 *
 */
class Parceiros_Contatos_Departamentos extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Parceiros / Contatos / Departamentos");
        $this->template->set_breadcrumb("Parceiros / Contatos / Departamentos", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('parceiro_contato_departamento_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Parceiros / Contatos  / Departamentos");
