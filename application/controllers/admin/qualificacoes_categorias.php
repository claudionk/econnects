...
/**
 * Class Qualificacoes_Categorias
 *
 * @property Qualificacao_Categoria_Model $current_model
 *
 */
class Qualificacoes_Categorias extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->template->set('page_title', "Categorias");
        $this->template->set_breadcrumb("Categorias", base_url("$this->controller_uri/index"));

        //Carrega modelos
        $this->load->model('qualificacao_categoria_model', 'current_model');
    }
    ...
    public function index($offset = 0) //Função padrão (load)
    {
        ...
        $this->template->set('page_subtitle', "Categorias");
    ...
    public function add() //Função que adiciona registro
    {
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Adicionar Categoria");
    ...
    public function edit($id) //Função que edita registro
    {
        ...
        //Setar variáveis de informação da página
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', "Editar Categoria");
