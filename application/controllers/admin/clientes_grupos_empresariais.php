 ...
 *
 * @property Grupo_Empresarial $current_model
 *
 */
class Clientes_Grupos_Empresariais extends Admin_Controller
{
    public function __construct()
    {
        ...
        $this->template->set('page_title', 'Grupo Empresarial');
        $this->template->set_breadcrumb('Grupo Empresarial', base_url("$this->controller_uri/index"));
        
        //Carrega modelos necessários
        $this->load->model('cliente_grupo_empresarial_model', 'current_model');
    }
    ...
    public function index($offset = 0)
    {
        ...
        $this->template->set('page_subtitle', 'Grupo Empresarial');
        $this->template->set_breadcrumb('Grupo Empresarial', base_url("$this->controller_uri/index"));
    ...
    {   
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Adicionar Item');
    ...
    public function edit($id)
    {
      //Carrega bibliotecas necessesárias
        ...
        $this->template->set('page_title_info', '');
        $this->template->set('page_subtitle', 'Editar Item');
