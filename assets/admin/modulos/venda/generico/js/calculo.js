        ...
        .done(function( result )
        {
            ...
            if(result.status == true)
            {
                ...
                $.each(result.valores_bruto, function (idx, obj)
                {
                    ...
                    console.log('.quantidade_one_'+idx, result.quantidade)
                    $('.quantidade_one_'+idx).val(result.quantidade);
                    $('.quantidade_two_'+idx).val(result.quantidade);
