$(function(){
    ...
    if(typeof layout != typeof undefined && layout != "front")
    {
        ...
        $('#vendas_planos').height($(".table_coberturas")[0].clientHeight+7);
    }
    ...
    if($("#slider-preco-two-container").hasClass( "preco_slider" )){
        ...
        //$(".plano_header").width($("#slider-one-container").width());
        //$(".plano_table td").width($("#slider-one-container").width());
    }else{
    ...
    $('.add-car').on('click',function()
    {
        ...
        console.log('planos: ',plano.toString(), planos);
        ...
        console.log('Nome Plano', $('.plano_nome_one_'+plano).html());
        ...
        quantidade.push($('.quantidade').val());
        $('#quantidade').val(quantidade.join(';'));
